...
## Setup
The project needs a file with valid login credentials for the tests to run properly. It is assumed that such file is named **credentials.txt** and is placed in the project's base directory. Login should be placed in the first line of the file and the password in the second one.
